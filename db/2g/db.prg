 ...
 * ----------------------------------------------------------------
 * $Source: c:/cvsroot/cl/sigma/sclib/db/2g/db.prg,v $
 * $Author: sasavranic $ $Date: 2004/04/27 11:02:01 $ 
 * $Revision: 1.37 $
 * $Log: db.prg,v $
 * Revision 1.37  2004/04/27 11:02:01  sasavranic
 * Rad sa sezonama - bugfix
 *
 * Revision 1.36  2004/01/13 19:07:29  sasavranic
 * appsrv konverzija
 *
 * Revision 1.35  2003/04/12 23:01:18  ernad
 * O_Edit (O_S_PRIREMA)
 *
 * Revision 1.34  2003/02/13 10:41:46  ernad
 * zaostali commit-i
 *
 * Revision 1.33  2003/01/21 16:18:22  ernad
 * planika gSQL=D bug tops
 *
 * Revision 1.32  2003/01/19 23:44:19  ernad
 * test network speed (sa), korekcija bl.lnk
 *
 * Revision 1.31  2003/01/15 12:39:10  ernad
 * bug 2003
 *
 * Revision 1.30  2003/01/14 03:23:34  ernad
 * exclusiv ... probelm mreza W2K ...
 *
 * Revision 1.29  2003/01/09 16:32:07  mirsad
 * vracanje bojenja zaglavlja glavnog ekrana kada se radi u sezon.podr.
 *
 * Revision 1.28  2003/01/07 15:13:40  mirsad
 * ispravke rada u sezonama
 *
 * Revision 1.27  2003/01/07 01:15:43  mirsad
 * ispravke za rad sa sezonama
 *
 * Revision 1.26  2003/01/06 15:28:59  mirsad
 * ispravka BUG-a pri promjeni sezone iz sezonskog podrucja
 *
 * Revision 1.25  2002/11/15 18:46:13  sasa
 * korekcija koda
 *
 * Revision 1.24  2002/11/14 09:38:56  mirsad
 * no message
 *
 * Revision 1.23  2002/11/12 15:11:18  mirsad
 * cSigmaBD atribut oDatabase-a dodan
 *
 * Revision 1.22  2002/10/02 17:23:04  mirsad
 * testiranje-sezone
 *
 * Revision 1.21  2002/08/19 10:01:47  ernad
 *
 *
 * podesenja za CLIP
 *
 * Revision 1.20  2002/06/24 07:00:37  ernad
 *
 *
 * GwDiskFree, ciscenja gateway
 *
 * Revision 1.19  2002/06/23 11:57:24  ernad
 * ciscenja sql - planika
 *
 * Revision 1.18  2002/06/21 16:00:51  ernad
 *
 *
 *
 * debug TDB:cRadimUSezona = NIL
 *
 * Revision 1.17  2002/06/20 16:52:06  ernad
 *
 *
 * ciscenje planika, uvedeno fmk/svi/specif.prg
 *
 * Revision 1.16  2002/06/20 12:53:11  ernad
 *
 *
 * ciscenje rada sezonsko<->radno podrucje ... prebacivanje db/1g -> db/2g
 *
 * Revision 1.15  2002/06/19 19:51:00  ernad
 *
 *
 * rad u sezonama, gateway
 *
 * Revision 1.14  2002/06/16 09:45:32  ernad
 * cKorisn, cSifra izbrisani, ipak ostaju u TAppMod
 *
 * Revision 1.13  2002/06/14 12:48:33  ernad
 * -
 *
 * Revision 1.12  2002/06/14 11:44:09  ernad
 * cKorisn, cSifra
 *
 * Revision 1.11  2002/06/14 11:42:03  ernad
 * -
 *
 */
